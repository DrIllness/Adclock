...
public class AlarmsFragment extends DaggerFragment implements AlarmsContract.View {
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putInt(FAB_VISIBILITY_STATE, mAddAlarmFab.getVisibility());
        Log.d("KEK", "Saved state as " + mAddAlarmFab.getVisibility());
    }
    ...
    public void onViewStateRestored(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mAddAlarmFab.setVisibility(savedInstanceState.getInt(FAB_VISIBILITY_STATE));
            Log.d("KEK", "Restored state as " + mAddAlarmFab.getVisibility());
        }
    }
